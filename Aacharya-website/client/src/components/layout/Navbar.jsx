                ...
                <div className={`header-bottom ${isOpen ? 'active' : ''}`}>
                    <nav className="main-nav header-layout-grid" style={{ padding: '0 5px', width: '100%' }}>
                        ...
                        <div className="bottom-nav-right grid-right align-right-anchor" style={{ display: 'flex', alignItems: 'center', gap: '1.5vw' }}>
                            ...
                            {user ? (
                                <div className="user-menu" style={{ display: 'none', alignItems: 'center', gap: '10px', color: 'rgba(255, 255, 255, 0.9)' }}>
                                ...
                                <Link to="/login" onClick={() => setIsOpen(false)} style={{ display: 'none' }}>
                    ...
                    {hamburgerView === 'puja' ? (
                        ...
                        <>
                            ...
                            {user ? (
                                ...
                                <NavLink to="/login" className={({ isActive }) => `hamburger-link${isActive ? ' active' : ''}`} style={{ display: 'none' }} onClick={() => setIsOpen(false)}><FiUser /> Login</NavLink>
                            )}
                        </>
                    ) : (
