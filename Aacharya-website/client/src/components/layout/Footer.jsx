                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-col footer-col--about">
                        ...
                        <div className="footer-socials">
                            <a href="https://www.instagram.com/dr_kunwar_harshit" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><FiInstagram /></a>
                            <a href="https://www.youtube.com/@dr_kunwar_harshit" target="_blank" rel="noopener noreferrer" aria-label="YouTube"><FiYoutube /></a>
                            <a href="https://x.com/DrHarshitkunwar" aria-label="X (formerly Twitter)"><FaXTwitter /></a>
                            <a href="https://www.linkedin.com/in/dr-kunwar-harshit-rajveer-a91119349?utm_source=share_via&utm_content=profile&utm_medium=member_android" aria-label="LinkedIn"><FiLinkedin /></a>
                        </div>
                    </div>
